...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarketRecieptContainer = __webpack_require__(159);

	ReactDOM.render(React.createElement(MarketRecieptContainer, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarketRecieptContainer = React.createClass({
		displayName: 'MarketRecieptContainer',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubmissionForm = React.createClass({
		...
		getDefaultProps: function getDefaultProps() {
			return { items: [{ fieldName: 'Market', placeholder: '', datalist: true, listValues: ['Bixby Park', 'Surf City Nights', 'Irvine - Discovery', 'Twila Reid Park', 'Anaheim Promenade', 'Huntington Beach Pier', 'Monrovia Street Fair', 'Great Park'], fieldType: 'text', requirnents: [] }, { fieldName: 'Employee', placeholder: '', datalist: true, listValues: ['Kevin Luna', 'Kiley', 'Ahmed'], fieldType: 'text', requirnents: [] }, { fieldName: 'Gross Sales', placeholder: '', datalist: false, listValues: [], fieldType: 'number', requirnents: [] }, { fieldName: 'Market Fee', placeholder: '', datalist: false, listValues: [], fieldType: 'number', requirnents: [] }, { fieldName: 'Employee Pay', placeholder: '', datalist: false, listValues: [], fieldType: 'number', requirnents: [] }, { fieldName: 'Employee\'s Expenses', placeholder: '', datalist: false, listValues: [], fieldType: 'number', requirnents: [] }, { fieldName: 'Starting Bank', placeholder: '', datalist: false, listValues: [], fieldType: 'number', requirnents: [] }, { fieldName: 'Due to Ah-Nuts', placeholder: '', datalist: false, listValues: [], fieldType: 'number', requirnents: [] }]
			};
		},
		/*getInitialState: function() {
	 	return { items: [] };
		...
		render: function render() {
			...
			if (this.state.values.datalist) {
				...
				input = React.createElement(
					'div',
					null,
					React.createElement('input', { list: '{dataListName}', id: '{inputLabelName}', name: '{inputLabelName}', placeholder: placeholder, className: 'col-xs-8 col-sm-8 col-md-8' }),
					React.createElement(
						'datalist',
				...
				input = React.createElement(
					'div',
					null,
					React.createElement('input', { id: '{inputLabelName}', name: '{inputLabelName}', placeholder: placeholder, className: 'col-xs-8 col-sm-8 col-md-8' })
				);
			}
